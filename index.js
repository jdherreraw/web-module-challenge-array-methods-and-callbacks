...
function getYears(array, getFinalsCallback) {
    const years = getFinalsCallback(array).map((element) => {
        return element.Year
    })
    return years
}
...
function getWinners(array, getFinalsCallback) {
    const homeOrAway = getFinalsCallback(array).map((element) => {
...
function getWinnersByYear(array, getFinalsCallback, getYearsCallback, getWinnersCallback) {
...
function getAverageGoals(array) {
    const averageHomeGoals = array.reduce((accumulator, element) => {
